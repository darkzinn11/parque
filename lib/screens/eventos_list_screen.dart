...
class _EventosListScreenState extends State<EventosListScreen> {
  ...
  void _solicitarEvento() async {
    final ok = await requireLogin(context, featureName: 'solicitar evento');
    if (!ok || !mounted) return;
    context.push('/tabs/home/eventos/solicitar');
  }
        ...
        children: [
            ...
            child: AspectRatio(
              ...
              child: data.image == null
                  ...
                  : CachedNetworkImage(
                      imageUrl: data.image!,
                      fit: BoxFit.cover,
                      errorWidget: (_, __, ___) => Container(color: const Color(0xFFEFEFEF)),
                    ),
            ),
          ),
          const SizedBox(height: 16),
          ...
          if (dateText.isNotEmpty) ...[
            ...
            Text(
              ...
              style: GoogleFonts.poppins(
                fontSize: 13,
                color: kDarkGray.withValues(alpha: .8),
              ),
            ),
          ],
        ],
