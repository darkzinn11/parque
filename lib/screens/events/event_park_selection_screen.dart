// lib/screens/events/event_park_selection_screen.dart
...
class EventParkSelectionScreen extends StatefulWidget {
  const EventParkSelectionScreen({super.key});

  @override
  State<EventParkSelectionScreen> createState() => _EventParkSelectionScreenState();
}

class _EventParkSelectionScreenState extends State<EventParkSelectionScreen> {
  final _repo = GoParkRepository();
  ...
  Future<void> _load() async {
    ...
    final parks = await _repo.fetchAll();
    if (mounted) {
      setState(() {
        _parks = parks;
        _isLoading = false;
      ...
      body: Column(
        ...
        children: [
          Padding(
            ...
            child: Text(
              'Selecione o parque onde deseja realizar seu evento.',
                    ...
                    : ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return _ParkCard(
                            ...
                            onTap: () => context.push(
                              '/tabs/home/eventos/solicitar/${park.id}',
                            ),
                          );
                        },
                      ),
